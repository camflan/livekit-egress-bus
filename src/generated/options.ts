...
export interface Options {
  ...
  topics: boolean;
  topicParams: TopicParamOptions | undefined;
  ...
  affinityFunc?: boolean | undefined;
...
export const Options: MessageFns<Options, "psrpc.Options"> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.topicParams = TopicParamOptions.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): Options {
    return {
      ...
      subscription: isSet(object.subscription)
        ? globalThis.Boolean(object.subscription)
        : false,
      topics: isSet(object.topics) ? globalThis.Boolean(object.topics) : false,
      topicParams: isSet(object.topicParams)
        ? TopicParamOptions.fromJSON(object.topicParams)
        : undefined,
      ...
      affinityFunc: isSet(object.affinityFunc)
        ? globalThis.Boolean(object.affinityFunc)
        : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<Options>, I>>(object: I): Options {
    ...
    message.topicParams =
      object.topicParams !== undefined && object.topicParams !== null
...
export const TopicParamOptions: MessageFns<
  TopicParamOptions,
...
> = {
  ...
  fromJSON(object: any): TopicParamOptions {
    return {
      ...
      singleServer: isSet(object.singleServer)
        ? globalThis.Boolean(object.singleServer)
        : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<TopicParamOptions>, I>>(
    base?: I,
  ): TopicParamOptions {
    return TopicParamOptions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TopicParamOptions>, I>>(
    object: I,
  ): TopicParamOptions {
    const message = createBaseTopicParamOptions();
...
export const protoMetadata = {
    ...
    enumType: [
      {
        name: "Routing",
        value: [
          { name: "QUEUE", number: 0, options: undefined },
          {
            name: "AFFINITY",
            number: 1,
            options: undefined,
    ...
    sourceCodeInfo: {
      location: [
        ...
        },
        {
          ...
          leadingComments: "",
          trailingComments:
            " Servers will join a queue, and only one will receive each request\n",
          leadingDetachedComments: [],
        },
        {
          path: [5, 0, 2, 1],
          ...
          leadingComments: "",
          trailingComments:
            " Servers will implement an affinity function for handler selection\n",
          leadingDetachedComments: [],
        },
        {
          path: [5, 0, 2, 2],
  ...
  references: {
    ".psrpc.Routing": Routing,
    ".psrpc.Options": Options,
    ".psrpc.TopicParamOptions": TopicParamOptions,
  },
