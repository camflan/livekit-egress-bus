...
export type IngressAudioEncodingPreset = typeof IngressAudioEncodingPreset[keyof typeof IngressAudioEncodingPreset];

export namespace IngressAudioEncodingPreset {
  export type OPUS_STEREO_96KBPS = typeof IngressAudioEncodingPreset.OPUS_STEREO_96KBPS;
  export type OPUS_MONO_64KBS = typeof IngressAudioEncodingPreset.OPUS_MONO_64KBS;
...
export type IngressVideoEncodingPreset = typeof IngressVideoEncodingPreset[keyof typeof IngressVideoEncodingPreset];

export namespace IngressVideoEncodingPreset {
  export type H264_720P_30FPS_3_LAYERS = typeof IngressVideoEncodingPreset.H264_720P_30FPS_3_LAYERS;
  export type H264_1080P_30FPS_3_LAYERS = typeof IngressVideoEncodingPreset.H264_1080P_30FPS_3_LAYERS;
  export type H264_540P_25FPS_2_LAYERS = typeof IngressVideoEncodingPreset.H264_540P_25FPS_2_LAYERS;
  export type H264_720P_30FPS_1_LAYER = typeof IngressVideoEncodingPreset.H264_720P_30FPS_1_LAYER;
  export type H264_1080P_30FPS_1_LAYER = typeof IngressVideoEncodingPreset.H264_1080P_30FPS_1_LAYER;
...
export type IngressState_Status = typeof IngressState_Status[keyof typeof IngressState_Status];

export namespace IngressState_Status {
  export type ENDPOINT_INACTIVE = typeof IngressState_Status.ENDPOINT_INACTIVE;
  export type ENDPOINT_BUFFERING = typeof IngressState_Status.ENDPOINT_BUFFERING;
  export type ENDPOINT_PUBLISHING = typeof IngressState_Status.ENDPOINT_PUBLISHING;
...
export const CreateIngressRequest: MessageFns<CreateIngressRequest, "livekit.CreateIngressRequest"> = {
...
function createBaseIngressAudioOptions(): IngressAudioOptions {
  return { $type: "livekit.IngressAudioOptions", name: "", source: 0, preset: undefined, options: undefined };
}

export const IngressAudioOptions: MessageFns<IngressAudioOptions, "livekit.IngressAudioOptions"> = {
  ...
  encode(message: IngressAudioOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.options !== undefined) {
      IngressAudioEncodingOptions.encode(message.options, writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
function createBaseIngressVideoOptions(): IngressVideoOptions {
  return { $type: "livekit.IngressVideoOptions", name: "", source: 0, preset: undefined, options: undefined };
}

export const IngressVideoOptions: MessageFns<IngressVideoOptions, "livekit.IngressVideoOptions"> = {
  ...
  encode(message: IngressVideoOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.options !== undefined) {
      IngressVideoEncodingOptions.encode(message.options, writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
function createBaseIngressAudioEncodingOptions(): IngressAudioEncodingOptions {
  return { $type: "livekit.IngressAudioEncodingOptions", audioCodec: 0, bitrate: 0, disableDtx: false, channels: 0 };
}
...
messageTypeRegistry.set(IngressAudioEncodingOptions.$type, IngressAudioEncodingOptions);

function createBaseIngressVideoEncodingOptions(): IngressVideoEncodingOptions {
  return { $type: "livekit.IngressVideoEncodingOptions", videoCodec: 0, frameRate: 0, layers: [] };
}
...
messageTypeRegistry.set(IngressVideoEncodingOptions.$type, IngressVideoEncodingOptions);
...
function createBaseInputVideoState(): InputVideoState {
  return { $type: "livekit.InputVideoState", mimeType: "", averageBitrate: 0, width: 0, height: 0, framerate: 0 };
}

export const InputVideoState: MessageFns<InputVideoState, "livekit.InputVideoState"> = {
...
function createBaseInputAudioState(): InputAudioState {
  return { $type: "livekit.InputAudioState", mimeType: "", averageBitrate: 0, channels: 0, sampleRate: 0 };
}

export const InputAudioState: MessageFns<InputAudioState, "livekit.InputAudioState"> = {
...
export const UpdateIngressRequest: MessageFns<UpdateIngressRequest, "livekit.UpdateIngressRequest"> = {
...
export const ListIngressRequest: MessageFns<ListIngressRequest, "livekit.ListIngressRequest"> = {
...
export const ListIngressResponse: MessageFns<ListIngressResponse, "livekit.ListIngressResponse"> = {
...
export const DeleteIngressRequest: MessageFns<DeleteIngressRequest, "livekit.DeleteIngressRequest"> = {
...
export const protoMetadata = {
  fileDescriptor: {
    ...
    "messageType": [{
      ...
      "enumType": [],
      "extensionRange": [],
      "oneofDecl": [{ "name": "_enable_transcoding", "options": undefined }, {
        "name": "_enabled",
        "options": undefined,
      }],
      "options": undefined,
      ...
      "enumType": [],
      "extensionRange": [],
      "oneofDecl": [{ "name": "_bypass_transcoding", "options": undefined }, {
    ...
    "enumType": [{
      "name": "IngressInput",
      "value": [{ "name": "RTMP_INPUT", "number": 0, "options": undefined }, {
        "name": "WHIP_INPUT",
        "number": 1,
        "options": undefined,
      ...
      "value": [{ "name": "OPUS_STEREO_96KBPS", "number": 0, "options": undefined }, {
      ...
      "value": [
        ...
        { "name": "H264_720P_30FPS_3_LAYERS_HIGH_MOTION", "number": 5, "options": undefined },
        { "name": "H264_1080P_30FPS_3_LAYERS_HIGH_MOTION", "number": 6, "options": undefined },
        { "name": "H264_540P_25FPS_2_LAYERS_HIGH_MOTION", "number": 7, "options": undefined },
        { "name": "H264_720P_30FPS_1_LAYER_HIGH_MOTION", "number": 8, "options": undefined },
        { "name": "H264_1080P_30FPS_1_LAYER_HIGH_MOTION", "number": 9, "options": undefined },
      ],
      "options": undefined,
      "reservedRange": [],
      "reservedName": [],
    ...
    "sourceCodeInfo": {
      "location": [{
        ...
        "path": [4, 0, 2, 1],
        "span": [36, 2, 17],
        "leadingComments": " Where to pull media from, only for URL input type\n",
        "trailingComments": "",
        "leadingDetachedComments": [],
      }, {
        "path": [4, 0, 2, 2],
        ...
        "path": [4, 0, 2, 5],
        "span": [44, 2, 30],
        "leadingComments": " name of publishing participant (used for display only)\n",
        "trailingComments": "",
        "leadingDetachedComments": [],
      }, {
        "path": [4, 0, 2, 6],
        "span": [46, 2, 35],
        "leadingComments": " metadata associated with the publishing participant\n",
        "trailingComments": "",
        "leadingDetachedComments": [],
      }, {
        "path": [4, 0, 2, 7],
        ...
        "span": [90, 2, 31],
        "leadingComments": "",
        "trailingComments": " 1280x720,  30fps, 1900kbps main layer, 3 layers total\n",
        "leadingDetachedComments": [],
      }, {
        "path": [5, 2, 2, 1],
        "span": [91, 2, 32],
        "leadingComments": "",
        "trailingComments": " 1980x1080, 30fps, 3500kbps main layer, 3 layers total\n",
        "leadingDetachedComments": [],
      }, {
        "path": [5, 2, 2, 2],
        "span": [92, 2, 31],
        "leadingComments": "",
        "trailingComments": "  960x540,  25fps, 1000kbps  main layer, 2 layers total\n",
        "leadingDetachedComments": [],
      }, {
        "path": [5, 2, 2, 3],
        "span": [93, 2, 30],
