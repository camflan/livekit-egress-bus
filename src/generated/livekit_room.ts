...
export const CreateRoomRequest: MessageFns<
  CreateRoomRequest,
...
> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.agents.push(
            RoomAgentDispatch.decode(reader, reader.uint32()),
          );
          continue;
        }
      }
  ...
  fromJSON(object: any): CreateRoomRequest {
    return {
      ...
      metadata: isSet(object.metadata)
        ...
        : "",
      egress: isSet(object.egress)
        ? RoomEgress.fromJSON(object.egress)
        : undefined,
      minPlayoutDelay: isSet(object.minPlayoutDelay)
        ? globalThis.Number(object.minPlayoutDelay)
        : 0,
      maxPlayoutDelay: isSet(object.maxPlayoutDelay)
        ? globalThis.Number(object.maxPlayoutDelay)
        : 0,
      syncStreams: isSet(object.syncStreams)
        ? globalThis.Boolean(object.syncStreams)
        : false,
      replayEnabled: isSet(object.replayEnabled)
        ? globalThis.Boolean(object.replayEnabled)
        : false,
  ...
  create<I extends Exact<DeepPartial<CreateRoomRequest>, I>>(
    base?: I,
  ): CreateRoomRequest {
  ...
  fromPartial<I extends Exact<DeepPartial<CreateRoomRequest>, I>>(
    ...
    message.agents =
      object.agents?.map((e) => RoomAgentDispatch.fromPartial(e)) || [];
    return message;
  },
};
...
export const RoomEgress: MessageFns<RoomEgress, "livekit.RoomEgress"> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.room = RoomCompositeEgressRequest.decode(
            reader,
            reader.uint32(),
          );
          continue;
        ...
        case 3: {
          ...
          message.participant = AutoParticipantEgress.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): RoomEgress {
    return {
      ...
      room: isSet(object.room)
        ? RoomCompositeEgressRequest.fromJSON(object.room)
        : undefined,
      participant: isSet(object.participant)
        ? AutoParticipantEgress.fromJSON(object.participant)
        : undefined,
      tracks: isSet(object.tracks)
        ? AutoTrackEgress.fromJSON(object.tracks)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RoomEgress>, I>>(
    object: I,
  ): RoomEgress {
    const message = createBaseRoomEgress();
    message.room =
...
export const RoomAgent: MessageFns<RoomAgent, "livekit.RoomAgent"> = {
  ...
  toJSON(message: RoomAgent): unknown {
    ...
    if (message.dispatches?.length) {
      obj.dispatches = message.dispatches.map((e) =>
        RoomAgentDispatch.toJSON(e),
      );
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RoomAgent>, I>>(
    object: I,
  ): RoomAgent {
    const message = createBaseRoomAgent();
    message.dispatches =
      object.dispatches?.map((e) => RoomAgentDispatch.fromPartial(e)) || [];
    return message;
  },
};
...
export const ListRoomsRequest: MessageFns<
  ListRoomsRequest,
...
> = {
  ...
  create<I extends Exact<DeepPartial<ListRoomsRequest>, I>>(
    base?: I,
  ): ListRoomsRequest {
...
export const ListRoomsResponse: MessageFns<
  ListRoomsResponse,
...
> = {
  ...
  create<I extends Exact<DeepPartial<ListRoomsResponse>, I>>(
    base?: I,
  ): ListRoomsResponse {
...
export const DeleteRoomRequest: MessageFns<
  DeleteRoomRequest,
...
> = {
  ...
  create<I extends Exact<DeepPartial<DeleteRoomRequest>, I>>(
    base?: I,
  ): DeleteRoomRequest {
...
export const DeleteRoomResponse: MessageFns<
  DeleteRoomResponse,
...
> = {
  ...
  create<I extends Exact<DeepPartial<DeleteRoomResponse>, I>>(
    base?: I,
  ): DeleteRoomResponse {
...
export const ListParticipantsRequest: MessageFns<
...
> = {
  ...
  fromJSON(object: any): ListParticipantsRequest {
    return {
      $type: ListParticipantsRequest.$type,
      room: isSet(object.room) ? globalThis.String(object.room) : "",
    };
  },
  ...
  create<I extends Exact<DeepPartial<ListParticipantsRequest>, I>>(
    base?: I,
  ): ListParticipantsRequest {
...
export const ListParticipantsResponse: MessageFns<
  ...
  toJSON(message: ListParticipantsResponse): unknown {
    ...
    if (message.participants?.length) {
      obj.participants = message.participants.map((e) =>
        ParticipantInfo.toJSON(e),
      );
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ListParticipantsResponse>, I>>(
    base?: I,
  ): ListParticipantsResponse {
...
export const RoomParticipantIdentity: MessageFns<
...
> = {
  ...
  create<I extends Exact<DeepPartial<RoomParticipantIdentity>, I>>(
    base?: I,
  ): RoomParticipantIdentity {
...
> = {
  ...
  create<I extends Exact<DeepPartial<RemoveParticipantResponse>, I>>(
    base?: I,
  ): RemoveParticipantResponse {
...
messageTypeRegistry.set(
  RemoveParticipantResponse.$type,
  RemoveParticipantResponse,
);
...
export const MuteRoomTrackRequest: MessageFns<
...
> = {
  ...
  fromJSON(object: any): MuteRoomTrackRequest {
    return {
      ...
      identity: isSet(object.identity)
        ? globalThis.String(object.identity)
        : "",
      trackSid: isSet(object.trackSid)
        ? globalThis.String(object.trackSid)
        : "",
  ...
  create<I extends Exact<DeepPartial<MuteRoomTrackRequest>, I>>(
    base?: I,
  ): MuteRoomTrackRequest {
...
export const MuteRoomTrackResponse: MessageFns<
...
> = {
  ...
  create<I extends Exact<DeepPartial<MuteRoomTrackResponse>, I>>(
    base?: I,
  ): MuteRoomTrackResponse {
...
export const UpdateParticipantRequest: MessageFns<
...
> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          const entry6 = UpdateParticipantRequest_AttributesEntry.decode(
            reader,
            reader.uint32(),
          );
  ...
  create<I extends Exact<DeepPartial<UpdateParticipantRequest>, I>>(
    base?: I,
  ): UpdateParticipantRequest {
...
> = {
  ...
  encode(
    message: UpdateParticipantRequest_AttributesEntry,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.key !== "") {
  ...
  create<
    I extends Exact<DeepPartial<UpdateParticipantRequest_AttributesEntry>, I>,
  >(base?: I): UpdateParticipantRequest_AttributesEntry {
    return UpdateParticipantRequest_AttributesEntry.fromPartial(
      base ?? ({} as any),
    );
  },
  fromPartial<
    I extends Exact<DeepPartial<UpdateParticipantRequest_AttributesEntry>, I>,
  >(object: I): UpdateParticipantRequest_AttributesEntry {
    const message = createBaseUpdateParticipantRequest_AttributesEntry();
...
messageTypeRegistry.set(
  UpdateParticipantRequest_AttributesEntry.$type,
  UpdateParticipantRequest_AttributesEntry,
);
...
export const UpdateSubscriptionsRequest: MessageFns<
  ...
  toJSON(message: UpdateSubscriptionsRequest): unknown {
    ...
    if (message.participantTracks?.length) {
      obj.participantTracks = message.participantTracks.map((e) =>
        ParticipantTracks.toJSON(e),
      );
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<UpdateSubscriptionsRequest>, I>>(
    base?: I,
  ): UpdateSubscriptionsRequest {
...
messageTypeRegistry.set(
  UpdateSubscriptionsRequest.$type,
  UpdateSubscriptionsRequest,
);
...
> = {
  ...
  create<I extends Exact<DeepPartial<UpdateSubscriptionsResponse>, I>>(
    base?: I,
  ): UpdateSubscriptionsResponse {
...
messageTypeRegistry.set(
  UpdateSubscriptionsResponse.$type,
  UpdateSubscriptionsResponse,
);
...
export const SendDataRequest: MessageFns<
  SendDataRequest,
...
> = {
  ...
  create<I extends Exact<DeepPartial<SendDataRequest>, I>>(
    base?: I,
  ): SendDataRequest {
...
export const SendDataResponse: MessageFns<
  SendDataResponse,
...
export const UpdateRoomMetadataRequest: MessageFns<
...
> = {
  ...
  create<I extends Exact<DeepPartial<UpdateRoomMetadataRequest>, I>>(
    base?: I,
  ): UpdateRoomMetadataRequest {
...
messageTypeRegistry.set(
  UpdateRoomMetadataRequest.$type,
  UpdateRoomMetadataRequest,
);
...
export const RoomConfiguration: MessageFns<
  RoomConfiguration,
...
> = {
  ...
  create<I extends Exact<DeepPartial<RoomConfiguration>, I>>(
    base?: I,
  ): RoomConfiguration {
    return RoomConfiguration.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RoomConfiguration>, I>>(
    object: I,
  ): RoomConfiguration {
    const message = createBaseRoomConfiguration();
    message.name = object.name ?? "";
